 ...
 */
@ActionDescriptor(
        name = "WAAE-job-on-hold",
        description = "WAAE sendevent start-job through webservice",
        category="Workload." )
    public class WAAEjobonhold extends Action {
    private static final long serialVersionUID = 1L;
    private static final Logger log = Logger.getLogger(WAAEjobonhold.class);
    ...
    public ActionResult execute() {
        ...
        try {
            log.debug("A call was received to execute a Restful Action: " + "WAAE-job-on-hold");
            ...
            response = new HttpRDKResponse("There was an error trying to execute a REST Call Action: '"
                + "WAAE-job-on-hold" + "' for Action Pack: "   + "", null, -1);
