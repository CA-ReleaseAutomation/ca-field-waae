 ...
 */
@ActionDescriptor(
        name = "WAAE-force-start-job",
        description = "WAAE sendevent force-start-job through webservice",
        category="Workload." )
    public class WAAEforcestartjob extends Action {
    private static final long serialVersionUID = 1L;
    private static final Logger log = Logger.getLogger(WAAEforcestartjob.class);
    ...
    public ActionResult execute() {
        ...
        try {
            log.debug("A call was received to execute a Restful Action: " + "WAAE-force-start-job");
            ...
            response = new RestClientManager().restCall(HttpMethod.POST, authType, getInput(),
                "${WAAE Web Server}/AEWS/event/force-start-job", 30, "", "application/json",
            ...
            response = new HttpRDKResponse("There was an error trying to execute a REST Call Action: '"
                + "WAAE-force-start-job" + "' for Action Pack: "   + "", null, -1);
